...
class BangladeshModel(Model):
    ...
    def __init__(
        ...
        self.roads = roads if roads is not None else ['N1']
    ...
    def generate_model(self):
        ...
        default_candidate = model_dir.parent / 'data' / 'n1_model.csv'
        fallback_candidate = model_dir.parent / 'data' / 'demo-1.csv'
        chosen_file = Path(self.input_file) if self.input_file else (
            default_candidate if default_candidate.exists() else fallback_candidate
        )
